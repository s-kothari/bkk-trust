...
const DonatePage: React.FC = () => {
  return (
    <div>
      <Hero
        title="Build Futures with BKK Trust"
        subtitle="Your contribution empowers women and children in Jaipur to build self-reliant futures. By helping them overcome barriers and providing access to education and skills, you create opportunities for growth and self-sufficiency."
        image={"/impact/music_2.png"}
      />
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8 pb-16">
            <div className="mx-auto max-w-4xl text-center">
              ...
              <p className="mt-6 text-lg leading-8 text-gray-600">
                ...
                providing access to education and skills, you create
          ...
          <div className="mt-16 grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:gap-x-8">
            ...
            <div className="rounded-2xl p-8 ring-1 ring-inset ring-gray-200 bg-white">
              ...
              <p className="mt-4 text-base leading-7 text-gray-600">
                ...
                education, vocational skills, and a supportive community. We
                help them achieve financial independence and lead dignified
                lives. Your support can provide literacy programs, computer
                classes, and training in stitching, mehendi art, and more.
              </p>
