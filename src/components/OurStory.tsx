    ...
    <div className="bg-amber-50/50 py-16 sm:py-24">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:mx-0">
          ...
          <p className="mt-6 text-lg leading-8 font-serif text-gray-600">
        ...
        <div className="mt-16 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-2">
          <div className="lg:pr-8 lg:pt-4">
            <div className="lg:max-w-lg">
              ...
              <p className="mt-6 text-lg leading-8 font-serif text-gray-700">
              ...
              <p className="mt-8 text-lg leading-8 font-serif text-gray-600">
        ...
        <div className="mt-16 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-2">
          <figure className="order-last lg:order-first">
            <div className="relative h-96 w-full sm:h-[500px] lg:h-[500px]">
              <Image
        ...
        <div className="mx-auto mt-16 max-w-2xl sm:mt-24 lg:mt-32 lg:max-w-4xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg leading-8 font-serif text-gray-600">
          ...
          <dl className="mt-12 grid grid-cols-1 gap-x-8 gap-y-10 sm:grid-cols-2 lg:grid-cols-2 lg:gap-y-16">
            <div className="relative pl-16">
              ...
              <dd className="mt-2 text-lg leading-8 font-serif text-gray-600">
