...
const ImpactPage: React.FC = () => {
  return (
    <div>
      <Hero
        title="Our Impact"
        subtitle="Creating lasting change and empowering our community in Jaipur, Rajasthan."
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-4xl text-center">
            <p className="mt-6 text-lg leading-8 text-gray-600">
              ...
              confidence and support system needed to build a self-reliant
              future.
            </p>
          </div>
        </div>
          ...
          <div className="mx-auto mt-16 max-w-2xl sm:mt-24 lg:mt-32 lg:max-w-none">
            <div className="text-center">
              ...
              <p className="mt-4 text-lg text-gray-600">
                ...
                providing them with a foundation to thrive. Our support extends
                to boys up to the age of 12, while girls can continue with us
